...
export function BillSummaryCard({ upcomingTotal, paidTotal, billCount }: BillSummaryCardProps) {
    ...
    >
      ...
      <View className="flex-row gap-6">
        ...
        <View className="flex-1">
          ...
          <Text className="text-lg font-bold text-surface-900 mt-0.5">{billCount}</Text>
        </View>
      </View>
    </View>
  );
