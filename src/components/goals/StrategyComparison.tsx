...
function StrategyCard({
  ...
  const strategyLabel =
    result.strategy === "avalanche"
      ? t("goals.avalanche" as any)
      : t("goals.snowball" as any);

  const payoffDateFormatted = new Date(result.payoffDate).toLocaleDateString(
    "en-US",
