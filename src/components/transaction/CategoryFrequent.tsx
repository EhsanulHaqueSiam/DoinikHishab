...
const ICON_EMOJI: Record<string, string> = {
  home: "\u{1F3E0}", zap: "\u26A1", flame: "\u{1F525}", droplets: "\u{1F4A7}", wifi: "\u{1F4F6}",
  smartphone: "\u{1F4F1}", shield: "\u{1F6E1}\uFE0F", "shopping-cart": "\u{1F6D2}", utensils: "\u{1F37D}\uFE0F",
  bus: "\u{1F68C}", bike: "\u{1F6B2}", fuel: "\u26FD", lamp: "\u{1F4A1}", heart: "\u2764\uFE0F",
  banknote: "\u{1F4B5}", package: "\u{1F4E6}", repeat: "\u{1F504}", tv: "\u{1F4FA}",
  "shopping-bag": "\u{1F6CD}\uFE0F", stethoscope: "\u{1F3E5}", "graduation-cap": "\u{1F393}",
  gift: "\u{1F381}", shirt: "\u{1F454}", "shield-alert": "\u{1F6E1}\uFE0F", plane: "\u2708\uFE0F",
  moon: "\u{1F319}", laptop: "\u{1F4BB}", briefcase: "\u{1F4BC}", code: "\u{1F4BB}",
  building: "\u{1F3E2}", "trending-up": "\u{1F4C8}", "plus-circle": "\u2795",
};
...
function AnimatedCategoryTile({
  ...
  return (
    <Pressable onPress={handlePress}>
      <Animated.View
        style={[animatedStyle]}
        className="w-20 items-center p-2 rounded-xl"
      >
