...
import type {
  ...
  PayDownGoal,
  GoalBudgetCategory,
} from "../services/goal-storage/types";
...
export function useGoals(): UseGoalsReturn {
  ...
  const addSaveUpGoal = useCallback(
    (goal: Omit<SaveUpGoal, "id">): SaveUpGoal => {
  ...
  const addPayDownGoal = useCallback(
    (goal: Omit<PayDownGoal, "id">): PayDownGoal => {
