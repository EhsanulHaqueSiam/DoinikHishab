...
import type { SaveUpGoal, PayDownGoal } from "../../src/services/goal-storage/types";
...
export default function GoalsScreen() {
  ...
  return (
    <View className="flex-1 bg-background">
      ...
      {/* Bottom sheet forms */}
      <GoalForm
        sheetRef={goalFormRef}
        onSave={handleSaveGoal as any}
      />
      <DebtForm
        sheetRef={debtFormRef}
        onSave={handleSaveDebt as any}
      />
    </View>
  );
}
