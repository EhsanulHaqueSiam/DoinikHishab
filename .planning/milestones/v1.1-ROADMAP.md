...
- [x] 03-03-PLAN.md -- Dashboard MetricsCard, onboarding UI components (RuleCarousel, StepIndicator, CategoryTemplateSelector), settings integration
- [x] 03-04-PLAN.md -- Onboarding flow: 5-step guided setup screens, root layout onboarding gate, human verification
**UI hint**: yes
...
- [x] 06-02-PLAN.md -- Import foundation: statement-parser service, bKash/Nagad parsers, xlsx install, type mapping, dedup, tests, import i18n keys
- [x] 06-03-PLAN.md -- Goals UI: GoalCard, GoalForm, DebtCard, DebtForm, AmortizationTable, StrategyComparison, useGoals hook, goals screens
- [x] 06-04-PLAN.md -- Import UI: FilePickerButton, ImportReviewList, ImportReviewRow, TypeMappingPill, useImport hook, import screen
- [x] 06-05-PLAN.md -- Integration: GoalDashboardCard, navigation wiring, budget goal categories, human verification
**UI hint**: yes
...
- [x] 07-02-PLAN.md -- Maestro E2E: testID props on critical components, 3 YAML flow files, shared onboarding sub-flow, GitHub Actions e2e.yml CI workflow
