...
const KEYWORD_RULES: Record<string, string[]> = {
  ...
  bKash: ["bkash", "b-kash"],
  Nagad: ["nagad"],
  "Online Shopping": ["daraz", "evaly", "chaldal", "pickaboo", "ajkerdeal", "amazon", "alibaba"],
  ...
  Education: ["tuition", "school", "college", "university", "coaching", "course", "udemy", "book"],
  Entertainment: ["netflix", "youtube", "spotify", "cinema", "movie", "subscription", "game"],
